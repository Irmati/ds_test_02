...
```{r}
namq_10_gdp <- get_eurostat("namq_10_gdp", stringAsFactors=FALSE)
...
ggplot(df, aes(x=time, y=values))+
        ...
        labs(title = "GDP and main components (output, expenditure and income)",
             subtitle = "source: Eurostat(nam_10_gdp)")+
        labs(x = "Laikotarpis")+
        labs(y = "darbo pajamų ir BVP santykis")
